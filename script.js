...
function closeModal() {
  ...
  eventTitleInput4.classList.remove('error');
  ...
  eventTitleInput4.value = '';
  clicked = null;
  load();
}

function saveEvent() {
  if (eventTitleInput.value && eventTitleInput2.value && eventTitleInput3.value && eventTitleInput4.value) {
    eventTitleInput.classList.remove('error');
    eventTitleInput2.classList.remove('error');
    eventTitleInput3.classList.remove('error');
    eventTitleInput4.classList.remove('error');
    ...
    events.push({
      date: clicked,
      title: eventTitleInput.value +', '+ eventTitleInput2.value +', '+ eventTitleInput3.value +', '+ eventTitleInput4.value,
    });
    ...
    eventTitleInput3.classList.add('error');
    eventTitleInput4.classList.add('error');
  }
}
...
function initButtons() {
  ...
  document.getElementById('saveButton2').addEventListener('click', saveEvent);
